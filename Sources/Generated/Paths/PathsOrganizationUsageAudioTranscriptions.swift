...
extension Paths.Organization.Usage {
    public var audioTranscriptions: AudioTranscriptions {
        AudioTranscriptions(path: path + "/audio_transcriptions")
    }

    public struct AudioTranscriptions {
        ...
        public func get(parameters: GetParameters) -> Request<OpenAIAPI.UsageResponse> {
            Request(path: path, method: "GET", query: parameters.asQuery, id: "usage-audio-transcriptions")
        }
