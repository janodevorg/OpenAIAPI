...
extension Paths.Organization.Usage {
    public var codeInterpreterSessions: CodeInterpreterSessions {
        CodeInterpreterSessions(path: path + "/code_interpreter_sessions")
    }

    public struct CodeInterpreterSessions {
        ...
        public func get(parameters: GetParameters) -> Request<OpenAIAPI.UsageResponse> {
            Request(path: path, method: "GET", query: parameters.asQuery, id: "usage-code-interpreter-sessions")
        }
