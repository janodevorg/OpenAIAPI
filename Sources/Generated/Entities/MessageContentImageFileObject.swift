...
public struct MessageContentImageFileObject: Codable {
    /// Always `image_file`.
    ...
    public init(type: `Type`, imageFile: ImageFile) {
        self.type = type
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.imageFile = try values.decode(ImageFile.self, forKey: "image_file")
    }

    public func encode(to encoder: Encoder) throws {
        var values = encoder.container(keyedBy: StringCodingKey.self)
        try values.encode(type, forKey: "type")
        try values.encode(imageFile, forKey: "image_file")
    }
}
