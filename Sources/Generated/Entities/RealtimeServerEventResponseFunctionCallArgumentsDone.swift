...
public struct RealtimeServerEventResponseFunctionCallArgumentsDone: Codable {
    ...
    public init(eventID: String, type: `Type`, responseID: String, itemID: String, outputIndex: Int, callID: String, arguments: String) {
