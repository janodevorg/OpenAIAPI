...
public struct ModifyAssistantRequest: Codable {
    ...
    public init(model: String? = nil, name: String? = nil, description: String? = nil, instructions: String? = nil, tools: [Tool]? = nil, toolResources: ToolResources? = nil, metadata: [String: AnyJSON]? = nil, temperature: Double? = nil, topP: Double? = nil, responseFormat: AssistantsAPIResponseFormatOption? = nil) {
        self.model = model
        self.name = name
