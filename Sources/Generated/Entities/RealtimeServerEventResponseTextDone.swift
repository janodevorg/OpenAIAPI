...
public struct RealtimeServerEventResponseTextDone: Codable {
    ...
    public init(eventID: String, type: `Type`, responseID: String, itemID: String, outputIndex: Int, contentIndex: Int, text: String) {
