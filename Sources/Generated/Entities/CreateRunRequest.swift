...
public struct CreateRunRequest: Codable {
    ...
    public init(assistantID: String, model: Model? = nil, instructions: String? = nil, additionalInstructions: String? = nil, additionalMessages: [CreateMessageRequest]? = nil, tools: [Tool]? = nil, metadata: [String: AnyJSON]? = nil, temperature: Double? = nil, topP: Double? = nil, isStream: Bool? = nil, maxPromptTokens: Int? = nil, maxCompletionTokens: Int? = nil, truncationStrategy: TruncationObject? = nil, toolChoice: AssistantsAPIToolChoiceOption? = nil, isParallelToolCalls: Bool? = nil, responseFormat: AssistantsAPIResponseFormatOption? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.additionalInstructions = try values.decodeIfPresent(String.self, forKey: "additional_instructions")
        self.additionalMessages = try values.decodeIfPresent([CreateMessageRequest].self, forKey: "additional_messages")
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try values.encodeIfPresent(additionalInstructions, forKey: "additional_instructions")
        try values.encodeIfPresent(additionalMessages, forKey: "additional_messages")
