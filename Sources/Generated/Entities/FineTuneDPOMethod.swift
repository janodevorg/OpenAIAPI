...
public struct FineTuneDPOMethod: Codable {
    ...
    public struct Hyperparameters: Codable {
        ...
        public init(beta: Beta? = nil, batchSize: BatchSize? = nil, learningRateMultiplier: LearningRateMultiplier? = nil, nEpochs: NEpochs? = nil) {
            self.beta = beta
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.beta = try values.decodeIfPresent(Beta.self, forKey: "beta")
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            try values.encodeIfPresent(beta, forKey: "beta")
